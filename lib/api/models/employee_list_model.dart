...
List<EmployerModel?> employerModelFromJson(String? str) => List<EmployerModel>.from(json.decode(str!).map((x) => EmployerModel.fromJson(x)));

String employerModelToJson(List<EmployerModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
